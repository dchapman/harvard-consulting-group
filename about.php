...
<head>
	...
	<title>Harvard Volunteer Consulting Group | Customized Breakthroughs at the Speed of Crimson</title>
...
<body class="about" data-spy="scroll" data-target=".subnav" data-offset="200">
	<header id="pageheader">
		<div class="main-nav navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="container">
					<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"></a>

					<a class="brand" href="home.html">HGVCG</a>
		...
		<div class="subnav navbar navbar-fixed-top visible-desktop">
			<div class="navbar-inner">
				<div class="container">
					<a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"></a>
	...
	<div id="main" role="main">
		<div class="container-fluid clearfix">
			...
			<div id="leadership" class="carousel-container section">
				<div class="container">
				...
				<div id="carousel-leadership" class="carousel slide">
					...
					<!-- Carousel nav -->
					<a class="carousel-control left" href="#carousel-leadership" data-slide="prev"></a>
					<a class="carousel-control right" href="#carousel-leadership" data-slide="next"></a>
				</div>
			</div>
			...
			<!--<div id="alums" class="light section">
				<div class="container">
					...
					<ul class="thumbnails">
						<li class="span6">
							<div class="thumbnail alum">
								<img src="http://lorempixel.com/142/142/people/" class="pull-left" alt="">

								<div class="caption no-wrap">
									<h3 class="name">Jai Sim</h3>
									<h3 class="title">Job Title / Company</h3>

									<p>Phasellus interdum sit amet elit et dignissim. In elementum, sem nec eleifend tincidunt.</p>
								</div>
							</div>
						</li>
	...
	<footer id="pagefooter" class="footer">
		<div class="container">
			<small>All content and copy &copy; 2013 Harvard Volunteer Consulting Group</small>
		</div>
	</footer>
	...
	<div id="contact-modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<form id="contact-form" class="form" method="post" action=".">
			...
			<div class="modal-footer">
				<button type="submit" class="btn btn-solid btn-outline pull-right">Submit</button>
			</div>
		</form>
	</div>
